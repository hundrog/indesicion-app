...
ReactDOM.render(React.createElement(IndecisionApp, null), document.getElementById("app")); // npx babel src/app.js -o public/scripts/app.js --presets=@babel/env,@babel/react --watch
